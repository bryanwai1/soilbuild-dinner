...
function SoilbuildLogo({ size = 60, showText = true, vertical = false, dark = false }) {
  ...
  return (
    <div style={{
      ...
      {/* Icon - transparent PNG, no background wrapper */}
      <img
        src={LOGO_B64}
        alt="Soilbuild"
        style={{
      ...
      {showText && (
        <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.1 }}>
          ...
          <div style={{
            ...
            fontWeight: 500,
            fontSize: subSize,
            color: dark ? "rgba(255,255,255,0.6)" : "#888888",
            letterSpacing: 1.8,
            textTransform: "uppercase",
            marginTop: 1,
          }}>Group Holdings Ltd</div>
        </div>
      )}
    </div>
  );
...
function FontLoader() {
  useEffect(() => {
    ...
    s.textContent = `@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=DM+Sans:wght@300;400;500;600;700&display=swap');*{box-sizing:border-box;margin:0;padding:0}body{font-family:'DM Sans',sans-serif}`;
...
function Nav({ page, setPage }) {
  ...
  return (
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(232,220,205,0.97)", backdropFilter: "blur(12px)", borderBottom: `1px solid rgba(92,61,30,0.2)`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px", height: 64 }}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: `linear-gradient(135deg, #F5F0E8 0%, #EDE4D3 100%)`, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", textAlign: "center", padding: "120px 24px 60px" }}>
        ...
        <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "clamp(14px,1.8vw,18px)", color: T.inkMid, letterSpacing: 4, textTransform: "uppercase", marginBottom: 16, fontWeight: 600, animation: "fadeInUp 1s ease-out 0.2s both" }}>
          {eventInfo.greeting}
        </div>
        <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(40px,8vw,90px)", fontWeight: 900, color: T.inkDark, lineHeight: 1.05, marginBottom: 12, maxWidth: 900, animation: "fadeInUp 1s ease-out 0.4s both" }}>
          {eventInfo.title}<br /><span style={{ color: T.green }}>{eventInfo.year}</span>
        </h1>
        <div style={{ width: 100, height: 3, background: `linear-gradient(90deg, transparent, ${T.yellowDark}, transparent)`, margin: "20px auto 32px", animation: "fadeIn 1s ease-out 0.6s both" }} />
        <div style={{ display: "flex", gap: 32, flexWrap: "wrap", justifyContent: "center", marginBottom: 48, animation: "fadeInUp 1s ease-out 0.8s both" }}>
          <div style={{ color: T.inkMid, fontFamily: "'DM Sans',sans-serif", fontSize: 15, fontWeight: 500 }}>📅 {eventInfo.date}</div>
          <div style={{ color: T.inkMid, fontFamily: "'DM Sans',sans-serif", fontSize: 15, fontWeight: 500 }}>🕕 {eventInfo.time}</div>
          <div style={{ color: T.inkMid, fontFamily: "'DM Sans',sans-serif", fontSize: 15, fontWeight: 500 }}>📍 {eventInfo.venue}</div>
        </div>
...
function RSVPPage({ employees, setEmployees, tables, setTables, eventInfo }) {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#F5F0E8", display: "flex", flexDirection: "column", alignItems: "center", padding: "100px 24px 40px" }}>
        {showEmailPreview && emailData && (
          <EmailPreviewModal emailData={emailData} confirmedData={confirmed} eventInfo={eventInfo} onClose={() => setShowEmailPreview(false)} />
        )}
        {emailSending && (
        ...
        <div style={{ background: `linear-gradient(135deg, #3B2A1A 0%, #2C1A0E 100%)`, borderRadius: 24, padding: "48px 40px", maxWidth: 520, width: "100%", border: `2px solid rgba(245,197,24,0.4)`, boxShadow: "0 32px 80px rgba(0,0,0,0.2)", position: "relative", overflow: "hidden", animation: "cardReveal 0.8s ease-out" }}>
          ...
          <div style={{ textAlign: "center", position: "relative" }}>
            ...
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "rgba(245,240,232,0.65)", marginBottom: 16 }}>to celebrate the</p>
            <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 38, fontWeight: 900, color: "#F5F0E8", lineHeight: 1.1, marginBottom: 4 }}>
              {eventInfo.title}<br /><span style={{ color: T.yellow }}>{eventInfo.year}</span>
            </h1>
            <div style={{ width: 60, height: 1, background: T.yellow, margin: "24px auto" }} />
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: "rgba(245,240,232,0.85)", marginBottom: 6 }}>📅 {eventInfo.date}</p>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: "rgba(245,240,232,0.85)", marginBottom: 6 }}>🕕 {eventInfo.time}</p>
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: "rgba(245,240,232,0.85)", marginBottom: 20 }}>📍 {eventInfo.venue}</p>
            <div style={{ marginTop: 24, padding: "16px 20px", background: "rgba(245,197,24,0.1)", borderRadius: 12, border: "1px solid rgba(245,197,24,0.3)" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, textAlign: "left" }}>
                <div>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 10, color: "rgba(245,240,232,0.5)", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 2 }}>Table</div>
                  <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 18, color: T.yellow, fontWeight: 700 }}>{confirmed.tableName}</div>
                </div>
                <div>
                  <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 10, color: "rgba(245,240,232,0.5)", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 2 }}>Pax</div>
  ...
  if (confirmed && confirmed.rsvpStatus === "declined") {
    return (
      <div style={{ minHeight: "100vh", background: "#F5F0E8", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 24px" }}>
        <div style={{ background: "#FAF7F2", borderRadius: 24, padding: 48, maxWidth: 480, width: "100%", textAlign: "center", boxShadow: "0 20px 60px rgba(92,61,30,0.1)", border: "1px solid #E8DFD0" }}>
...
function AdminDashboard({ employees, setEmployees, tables, setTables, prizes, setPrizes, winners, eventInfo, setEventInfo, onLogout, setPage }) {
  ...
  const addPerson = () => {
    ...
    setEmployees(prev => [...prev, { id: uid(), ...newPerson, drawEligible: true, tableId: null, rsvpStatus: "pending" }]);
  ...
  const bulkImport = () => {
    ...
    const newEmps = lines.map(line => {
      ...
      return { id: uid(), name: parts[0] || "", employeeNumber: parts[1] || "", email: parts[2] || "", pax: parseInt(parts[3]) || 1, drawEligible: true, tableId: null, rsvpStatus: "pending" };
      ...
      <div style={{ background: "#EDE4D3", borderBottom: "1px solid #D4C4A8", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: T.inkMid, opacity: 0.7 }}>{eventInfo.title} {eventInfo.year}</div>
          </div>
        </div>
            ...
            <div style={{ background: "#FAF7F2", borderRadius: 12, padding: 28, border: "1px solid #E8DFD0" }}>
              <div style={{ marginBottom: 20 }}>
                ...
                <input
                  ...
                  placeholder="RSVP Confirmed - Soilbuild Annual Dinner 2026"
                  style={{ width: "100%", padding: "10px 14px", borderRadius: 8, border: "1.5px solid #E8DFD0", fontFamily: "'DM Sans',sans-serif", fontSize: 14, outline: "none", background: T.white, color: T.inkDark }}
                  onFocus={e => e.target.style.borderColor = T.green}
                  onBlur={e => e.target.style.borderColor = "#E8DFD0"}
                />
        ...
        {tab === "people" && (
          <div>
            <div style={{ display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" }}>
              ...
              <button onClick={() => setShowBulk(!showBulk)} style={{ background: T.darkGreen, color: T.white, border: "none", borderRadius: 7, padding: "8px 16px", fontFamily: "'DM Sans',sans-serif", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>📋 Bulk Import</button>
            </div>

            {showBulk && (
              <div style={{ background: "#FAF7F2", borderRadius: 12, padding: 20, marginBottom: 20, border: "1px solid #E8DFD0" }}>
                <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: T.gray, marginBottom: 8 }}>Paste CSV: <strong>Name, EmployeeNumber, Email, Pax</strong> (one per line)</p>
                <textarea value={bulkText} onChange={e => setBulkText(e.target.value)} rows={5}
                  style={{ width: "100%", padding: 10, borderRadius: 7, border: `1px solid ${T.border}`, fontFamily: "monospace", fontSize: 12, marginBottom: 10, resize: "vertical" }}
                  placeholder={"Ahmad Hassan, SB001, ahmad@example.com, 2\nSiti Nurhaliza, SB002, siti@example.com, 1"} />
                <div style={{ display: "flex", gap: 8 }}>
                  <button onClick={bulkImport} style={{ background: T.green, color: T.white, border: "none", borderRadius: 7, padding: "8px 16px", fontFamily: "'DM Sans',sans-serif", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Import</button>
                  <button onClick={() => setShowBulk(false)} style={{ background: "#EDE4D3", color: T.inkDark, border: "none", borderRadius: 7, padding: "8px 14px", fontFamily: "'DM Sans',sans-serif", fontSize: 13, cursor: "pointer" }}>Cancel</button>
                </div>
              </div>
            )}
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "#EDE4D3" }}>
                    {["Name", "Employee No.", "Email", "Pax", "RSVP", "Table", "Draw", "Actions"].map(h => (
                    ...
                    <tr key={e.id} style={{ borderTop: `1px solid ${T.border}`, background: i % 2 === 0 ? "#FAF7F2" : "#F5F0E8" }}>
                      {editId === e.id ? (
                        ...
                        <>
                          ...
                          <td style={{ padding: "12px 14px", fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: T.gray, maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{e.email || "—"}</td>
...
function DrawAdmin({ employees, setEmployees, prizes, setPrizes, winners, setWinners, eventInfo, onLogout, setPage }) {
  ...
  const goLiveOnAllScreens = () => broadcast({ type: "FORCE_AUDIENCE_VIEW" });
  ...
  const bcast = (extra) => broadcast({
    type: "DRAW_STATE",
    payload: { displayMode, ...extra },
  });
  ...
  const revealNext = () => {
    ...
    broadcast({ type: "REVEAL_COUNT", payload: next });
    fx.fanfare();
  };
  ...
  const spinTicker = (pool, duration, onDone) => {
    ...
    spinRef.current = setInterval(() => {
      const name = pickRandom(pool)?.name || "—";
      setSpinName(name);
      broadcast({ type: "SPIN_NAME", payload: name });
      elapsed += 80;
      if (elapsed >= duration) {
        clearInterval(spinRef.current);
        onDone();
  ...
  const runCountdown = (onDone) => {
    ...
    countRef.current = setInterval(() => {
      ...
      if (c > 0) {
        ...
        broadcast({ type: "COUNTDOWN_TICK", payload: c });
      } else {
        clearInterval(countRef.current);
        setCountdown(null);
        // tell audience countdown is done (null = hide it)
        broadcast({ type: "COUNTDOWN_TICK", payload: null });
        onDone();
      }
    }, 1000);
  };
  ...
  const startNormalDraw = () => {
    ...
    // Tell audience a new draw is starting (resets their state)
    broadcast({ type: "DRAW_STATE", payload: { displayMode, active: true, spinning: false, winners: [], countdown: null, prize }});
    // Start the countdown ticks
    broadcast({ type: "COUNTDOWN_TICK", payload: 3 });
    ...
    runCountdown(() => {
      ...
      spinTicker(pool, 4000, () => {
        ...
        // send to audience — revealedCount starts at 0, host presses Reveal
  ...
  const startMultiPrizeDraw = () => {
    ...
    broadcast({ type: "DRAW_STATE", payload: {
    ...
    runCountdown(() => {
      const runNext = (idx, accWinners, usedIds) => {
        ...
        spinTicker(pool, 3000, () => {
          const emp    = pickRandom(pool);
          ...
          // Pause so audience can see the spin result, then next prize
...
function AudienceScreen({ eventInfo }) {
  ...
  useEffect(() => {
    ...
    ch.onmessage = (e) => {
      ...
      if (type === "DRAW_STATE") {
        setDrawState(prev => {
          if (!payload.active) { setRevealedCount(0); setCountdown(null); }
          if (payload.countdown && payload.countdown > 0) {
            setRevealedCount(0);
            setCountdown(payload.countdown);
          }
          return payload;
        });
        if (payload.spinning) fx.spinSound();
      } else if (type === "COUNTDOWN_TICK") {
        // payload is the new countdown value (3,2,1) or null when done
        setCountdown(payload);
        if (payload && payload > 0) fx.tick();
      } else if (type === "SPIN_NAME") {
        setSpinDisplay(payload);
      } else if (type === "REVEAL_COUNT") {
        setRevealedCount(payload);
        fx.fanfare();
      }
    };
    return () => ch.close();
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "linear-gradient(135deg, #1A3D1F 0%, #0D1B0F 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
      ...
      {/* ── SPINNING ─────────────────────────────────────────────────────── */}
      {spinning && (
        <div style={{ textAlign: "center", position: "relative", zIndex: 2, padding: "0 32px", width: "100%", maxWidth: 800 }}>
          {prize && (
          ...
          <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "rgba(255,255,255,0.35)", letterSpacing: 4, marginBottom: 20, textTransform: "uppercase" }}>
            Drawing Winner…
          </div>
          <div style={{ background: "rgba(245,197,24,0.07)", border: "2px solid rgba(245,197,24,0.35)", borderRadius: 20, padding: "40px 60px", boxShadow: "0 0 80px rgba(245,197,24,0.2)", animation: "spinPulse 0.45s ease-in-out infinite alternate" }}>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(36px,7vw,88px)", fontWeight: 900, color: T.yellow, minWidth: 300, textAlign: "center", minHeight: 80, textShadow: "0 0 40px rgba(245,197,24,0.6)" }}>
              {spinDisplay}
            </div>
          </div>
          {/* show partial winners (multi-prize) */}
          {allWinners.length > 0 && (
